...
const Insights = () => {
	// make it more intersting, change color of boxes and add icons and animations
	return (
		<Flex>
			...
			<Flex>
				...
				<BoxSize
					flexSize="1"
					style={{ background: MainYellow, color: "black" }}
				>
					<Heading
						{...SubHeader}
			...
			<Flex>
				<BoxSize flexSize="1" style={{ background: DarkTheme }}>
					...
					<Parag>
						Customers approved to reduce their carbon footprint since joining
						the program
					</Parag>
				</BoxSize>
				<BoxSize
					flexSize="1"
					style={{ background: DarkerTheme, border: "1px solid white" }}
				>
					<Heading
						{...SubHeader}
						style={{ fontSize: "1.8rem", marginBottom: "1rem" }}
					...
					<Parag>
						Are benefeting from your projects since joining the program
					</Parag>
				</BoxSize>
